...
(function() {
  ...
  person.prototype = {
    ...
    initView: function() {
      ...
      this.headview = new PIXI.Sprite(this.assets.textures.head[this.headType].standing);
    ...
    animateStand: function() {
      if (this.counter % 10 === 0) {
        this.headview.y = -9;
        this.headview.x = 11;
        this.headview.setTexture(this.assets.textures.head[this.headType].standing);
    ...
    animateClimb: function() {
      if (this.counter % 5 === 0) {
        ...
        this.headview.y = -7;
        this.headview.x = 11;
        this.headview.setTexture(this.assets.textures.head[this.headType].back);
    ...
    animateMoving: function(counter) {
      if (this.counter % 6 === 0) {
        ...
        if (this.isMovingLeft) {
          this.headview.y = -10;
          this.headview.x = 7;
          this.headview.setTexture(this.assets.textures.head[this.headType].sideLeft[0]);
          this.bodyview.setTexture(this.assets.textures.body.runningLeft[bodyStep]);
        } else {
          this.headview.y = -10;
          this.headview.x = 12;
          this.headview.setTexture(this.assets.textures.head[this.headType].side[0]);
    ...
    getFace: function() {
      return new PIXI.Sprite(this.assets.textures.head[this.headType].standing);
    },
    ...
    adjustUI: function() {
      if (this.selectedHalo) {
        this.selectedHalo.x = this.pos.x;
        this.selectedHalo.y = this.pos.y - 5;
      }
