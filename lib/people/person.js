  ...
  person.prototype = {
    ...
    initTextures: function() {
      ...
      for (i in this.bodyImage.death) {
        var textureFix = new PIXI.Texture.fromImage(this.bodyImage.death[i]);
        this.textures.body.death.push(textureFix);
      }
    },
    initView: function() {
      this.initTextures();
    ...
    hit: function(damage) {
      ...
      console.log(robustness, randomSeed, damage, personalDamage);
      this.health -= personalDamage;
      if (this.health <= 0) {
        this.health = 0;
        this.die();
      }
