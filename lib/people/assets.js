...
window.boot.assets.person = {
  ...
  initPersonIconTextures: function() {
    this.modifiersTextures = {
      ...
      positive: PIXI.Texture.fromImage('assets/people/star.png'),
      negative: PIXI.Texture.fromImage('assets/people/star.png'),
      love: PIXI.Texture.fromImage('assets/people/star.png'),
      racist: PIXI.Texture.fromImage('assets/people/star.png'),
      homophobia: PIXI.Texture.fromImage('assets/people/star.png'),
      claustrophobic: PIXI.Texture.fromImage('assets/people/star.png')
    };
  },
