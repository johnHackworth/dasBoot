...
window.boot.assets.person = {
  ...
  initHeadTextures: function() {
    ...
    for (i = 0; i < 3; i++) {
      ...
      this.textures.head[i].background.push(new PIXI.Texture(this.headSpriteSheet, new PIXI.Rectangle(400, 200, 100, 100)));
      this.textures.head[i].background.push(new PIXI.Texture(this.headSpriteSheet, new PIXI.Rectangle(500, 200, 100, 100)));
      this.textures.head[i].background.push(new PIXI.Texture(this.headSpriteSheet, new PIXI.Rectangle(600, 200, 100, 100)));
    }
  },
  initHeadHighResTextures: function() {
    ...
    for (i = 0; i < 3; i++) {
      ...
      this.texturesHighRes.head[i].background.push(new PIXI.Texture(this.headSpriteSheet, new PIXI.Rectangle(800, 400, 200, 200)));
      this.texturesHighRes.head[i].background.push(new PIXI.Texture(this.headSpriteSheet, new PIXI.Rectangle(1000, 400, 200, 200)));
      this.texturesHighRes.head[i].background.push(new PIXI.Texture(this.headSpriteSheet, new PIXI.Rectangle(1200, 400, 200, 200)));
    }
  },
  ...
  initFacialHighResTextures: function() {
    ...
    var w = 200;
    for (i = 0; i < 11; i++) {
      this.texturesHighRes.facialFeatures[i] = {};
      this.texturesHighRes.facialFeatures[i].standing = (
        new PIXI.Texture(this.facialSpriteSheet, new PIXI.Rectangle(0, w * i, w, w))
      );

      this.texturesHighRes.facialFeatures[i].back = (
        new PIXI.Texture(this.facialSpriteSheet, new PIXI.Rectangle(2 * w, w * i, w, w))
      );

      this.texturesHighRes.facialFeatures[i].side = (
        new PIXI.Texture(this.facialSpriteSheet, new PIXI.Rectangle(w, w * i, w, w))
      );

      this.texturesHighRes.facialFeatures[i].sideLeft = (
        new PIXI.Texture(this.facialSpriteSheet, new PIXI.Rectangle(3 * w, w * i, w, w))
      );
