  ...
  modalWindow.prototype = {
    ...
    addButtons: function() {
      ...
      for (var i in this.actions) {
        this.addActionButton(this.actions[i], i + 1);
      }
    },
    addActionButton: function(action, pos) {
      var yPosition = this.y + this.height - (1 + pos) * 60;
      var xPosition = this.x + (this.width / 2) - 80;
