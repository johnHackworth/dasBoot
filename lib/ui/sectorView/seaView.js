...
(function() {
  ...
  ui.prototype = {
    ...
    addSky: function() {
      this.skyView = this.stage.addBackground(this.initSeaX, 0, this.seaWidth, 150, this.sector.weather.skyColor, 1);
    ...
    tick: function(counter, active) {
      ...
      if (this.combatSimulator.canPlayerLeave()) {
    ...
    initializeHideScreen: function() {
      this.hideScreen = this.stage.addBackground(0, 0, this.seaWidth, 250, 0x444444, 1);
      this.hideScreen.visible = false;
    },
    hide: function() {
      this.isHidden = true;
      if (this.hideScreen) {
        this.hideScreen.visible = true;
