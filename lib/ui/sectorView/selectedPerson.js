...
(function() {
  ...
  personView.prototype = {
    ...
    showName: function() {
      var view = this.stage.addText(this.person.model.rank + ' ' + this.person.model.name, {
        x: this.x + 70,
        y: this.y + 3,
        fontSize: '12px',
    ...
    showAttributes: function() {
      var x = 0;
      var y = 0;
      for (var i in this.person.model.attributes.physicalAttributes) {
        var view = new PIXI.Sprite.fromImage(this.assets.attrPath + this.person.model.attributes.physicalAttributes[i] + '.png');
        view.width = 40;
        view.height = 40;
        ...
        this.views.push(view);
        this.stage.addVisualEntity(view);
        var value = this.person.model.attributes[this.person.model.attributes.physicalAttributes[i]];
