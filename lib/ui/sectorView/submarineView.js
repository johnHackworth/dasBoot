...
(function() {
  ...
  submarineView.prototype = {
    ...
    addSea: function() {
      this.initSky = 280;
      this.initSea = 460;
      console.log('weather :' + JSON.stringify(this.sector.weather));
      this.skyView = this.stage.addBackground(0, this.initSky, window.boot.config.width, 250, this.sector.weather.skyColor, 1);
      this.skyView.tint = this.sector.weather.tint;
      this.seaView = this.stage.addBackground(0, this.initSea, window.boot.config.width, 600, 0x0066AA, 1);
