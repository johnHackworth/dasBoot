...
(function() {
  ...
  mapLayout.prototype = {
    ...
    addBackground: function() {
      ...
      this.backgroundColor = this.stage.addBackground(50, 50, width - 100, height - 200, 0x006099, 1, [], null, false);
      ...
      this.backgroundMap.height = (height - 200) / 1.06;
      this.backgroundMap.width = (width - 100) / 1.92;
      this.backgroundMap.tint = 0x008800;
