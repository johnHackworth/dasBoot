...
(function() {
  ...
  mapLayout.prototype = {
    ...
    addBackground: function() {
      ...
      this.backgroundColor = this.stage.addBackground(50, 50, width - 100, height - 100, 0x0077BB, 1, [], null, false);

      this.backgroundMap = new PIXI.Sprite.fromImage(this.mapImage);
      this.backgroundMap.x = Math.floor((width - 100) / 2.05);
      this.backgroundMap.y = 40;
      this.backgroundMap.height = (height - 100) / 1.00;
      this.backgroundMap.width = (width - 100) / 1.80;
    ...
    getSectorsMapSize: function() {
      ...
      var tileHeight = (height - 120) / mapHeigth - 2;
    ...
    checkEncounters: function() {
      if (this.world.checkPlayerEncounters()) {
        this.warningWindow = new boot.ui.ModalWindow({
          stage: this.stage,
          actionOnClose: boot.mainDirector.testStartSubmarine.bind(boot.mainDirector),
