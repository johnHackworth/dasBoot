...
(function() {
  ...
  room.prototype = {
    ...
    tick: function(counter, active) {
      ...
      if (this.hullIntegrity <= 10 && this.counter % 10 === 0) {
        this.fillWithWater();
      }
    ...
    refreshWaterFillView: function() {
      if (this.waterFillView) {
        this.stage.removeView(this.waterFillView);
      }
      if (this.waterFill > 0) {
        ...
        this.waterFillView = this.stage.addBackground(this.view.x, this.view.y + this.roomHeight + 10 - waterHeight, this.roomWidth, waterHeight, 0x000077, 0.5, [], null, false);
