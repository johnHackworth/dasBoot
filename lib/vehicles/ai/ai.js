...
(function() {
  ...
  ai.prototype = {
    possibleStances: {
      'attack': {behaviour: 'searchEnemy', manage: 'manageOffensive'},
      'fly': {behaviour: 'searchEnemy', manage: 'manageOffensive'},
      'defend': {behaviour: 'searchEnemy', manage: 'manageOffensive'},
      'neutral': {behaviour: 'searchEnemy', manage: 'manageOffensive'},
      'back': {behaviour: 'searchEnemy', manage: 'manageOffensive'},
      'ahead': {behaviour: 'searchEnemy', manage: 'manageOffensive'}
    },
      ...
      if (this.boat.npc) {
        for (var i in this.boat.weapons.deepCharge) {
          ...
          if (this.boat.weapons.deepCharge[i].status == 'ready') {
            this.boat.launchDeepcharge(this.boat.weapons.deepCharge[i]);
